# To-fix-mfpwebencrypt-for-IOS
In MFP 8.0 onwards, --mfpwebencrypt is used for encrypt the web resources and it makes resources.zip file in www folder. But, it will not load the encrypted resources when app starts. It is an issue in MFP 8.0 plugin onwards. To fix this replace your AppDelegeate.m file with this file.
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
  ...
  // [super application:application didFinishLaunchingWithOptions:launchOptions];
    ...
    [[NSNotificationCenter defaultCenter]addObserverForName:@"wlsuccess" object:nil queue:nil usingBlock:^(NSNotification * note) {
...
-(void)wlInitWebFrameworkDidCompleteWithResult:(WLWebFrameworkInitResult *)result
{
    if ([result statusCode] == WLWebFrameworkInitResultSuccess) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName: @"wlsuccess" object:nil];
    } else {
